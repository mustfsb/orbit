...
export default function DuffyMichaelPage() {
  return (
    <MarketingPage>
          ...
          <div className="max-w-site mx-auto flex items-center justify-between py-5">
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-muted-foreground/50">/</span>
                  <span className="text-primary truncate max-w-[30ch]">Michael Duffy</span>
                </li>
              </ol>
            </nav>
          </div>
      ...
      <section className="px-site pt-section pb-12 lg:pb-16">
        <div className="max-w-[650px] mx-auto">
          <div className="w-32 h-32 rounded-2xl overflow-hidden bg-muted mb-8 border-[0.5px] border-foreground/15">
            <Image src="/assets/images/members/bio_duffy.png" alt="Michael Duffy" width={128} height={128} className="w-full h-full object-cover" />
          </div>
          <h2>Michael Duffy</h2>
          <div className="flex items-center gap-2 text-muted-foreground mt-4 mb-8">
            <span className="font-sans text-[15px] leading-[25.5px] text-muted-foreground">Acting Federal Chief Information Security Officer</span>
            <span className="text-muted-foreground/40">·</span>
            <span className="font-sans text-[15px] leading-[25.5px] text-muted-foreground">Office of Management and Budget</span>
          </div>
